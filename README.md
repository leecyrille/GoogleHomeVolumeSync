...
- **Calendar on TV**: show the [PactoTech Calendar Saver](https://calendarsaver.com/) (a free wall-calendar screensaver for Windows) on Roku TVs, Nest Hubs and Chromecasts, refreshed every minute, or make it a Roku TV's screensaver (Settings › Theme › Screensaver › Calendar (Volume Sync)). The calendar is drawn on this PC and sent as a picture, so the PC needs to be on.
