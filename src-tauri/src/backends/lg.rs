        ...
        loop {
            tokio::select! {
                ...
                cmd = self.cmd_rx.recv() => {
                    ...
                    if !registered || matches!(cmd, DeviceCmd::Power(_) | DeviceCmd::Input(_) | DeviceCmd::Key(_)) { continue; }
                    ...
                    let (uri, payload) = match cmd {
                        ...
                        DeviceCmd::Shutdown | DeviceCmd::Power(_) | DeviceCmd::Input(_) | DeviceCmd::Key(_) => unreachable!(),
                    };
