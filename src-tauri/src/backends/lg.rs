        ...
        loop {
            tokio::select! {
                ...
                cmd = self.cmd_rx.recv() => {
                    ...
                    if !registered || matches!(cmd, DeviceCmd::Power(_) | DeviceCmd::Input(_) | DeviceCmd::Key(_) | DeviceCmd::Seek(_) | DeviceCmd::Resync | DeviceCmd::Cast(_) | DeviceCmd::PollMedia | DeviceCmd::StopCasting) { continue; }
                    ...
                    let (uri, payload) = match cmd {
                        ...
                        DeviceCmd::Shutdown | DeviceCmd::Power(_) | DeviceCmd::Input(_) | DeviceCmd::Key(_) | DeviceCmd::Seek(_) | DeviceCmd::Resync | DeviceCmd::Cast(_) | DeviceCmd::PollMedia | DeviceCmd::StopCasting => unreachable!(),
                    };
